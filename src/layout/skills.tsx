...
export default function Skills() {
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto space-y-4 flex gap-2 flex-wrap justify-center">
        {skills.map((skill, index) => (
          ...
          >
            <div className="flex justify-between mb-1 gap-2 border p-3 px-6 rounded-full bg-card shadow-md">
